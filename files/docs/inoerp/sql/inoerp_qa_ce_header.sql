...
--
-- Table structure for table `qa_ce_header`
--

DROP TABLE IF EXISTS `qa_ce_header`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qa_ce_header` (
  `qa_ce_header_id` int NOT NULL AUTO_INCREMENT,
  ...
  `decimal_position` int DEFAULT NULL,
  `uom_id` int DEFAULT NULL,
  `default_value` varchar(50) DEFAULT NULL,
  `option_header_id` int DEFAULT NULL,
...
--
-- Dumping data for table `qa_ce_header`
--

LOCK TABLES `qa_ce_header` WRITE;
/*!40000 ALTER TABLE `qa_ce_header` DISABLE KEYS */;
/*!40000 ALTER TABLE `qa_ce_header` ENABLE KEYS */;
UNLOCK TABLES;
