...
DROP TABLE IF EXISTS `qa_ce_bgm_calibration_reading`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qa_ce_bgm_calibration_reading` (
  `qa_ce_bgm_calibration_reading_id` int NOT NULL AUTO_INCREMENT,
  ...
  `qa_cp_header_id` int DEFAULT NULL,
...
--
-- Dumping data for table `qa_ce_bgm_calibration_reading`
--

LOCK TABLES `qa_ce_bgm_calibration_reading` WRITE;
/*!40000 ALTER TABLE `qa_ce_bgm_calibration_reading` DISABLE KEYS */;
/*!40000 ALTER TABLE `qa_ce_bgm_calibration_reading` ENABLE KEYS */;
UNLOCK TABLES;
