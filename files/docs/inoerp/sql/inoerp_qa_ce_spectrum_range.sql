...
DROP TABLE IF EXISTS `qa_ce_spectrum_range`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qa_ce_spectrum_range` (
  `qa_ce_spectrum_range_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `qa_ce_spectrum_range`
--

LOCK TABLES `qa_ce_spectrum_range` WRITE;
/*!40000 ALTER TABLE `qa_ce_spectrum_range` DISABLE KEYS */;
/*!40000 ALTER TABLE `qa_ce_spectrum_range` ENABLE KEYS */;
UNLOCK TABLES;
