...
DROP TABLE IF EXISTS `qa_ce_higher_bandwidth1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qa_ce_higher_bandwidth1` (
  `qa_ce_higher_bandwidth1_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `qa_ce_higher_bandwidth1`
--

LOCK TABLES `qa_ce_higher_bandwidth1` WRITE;
/*!40000 ALTER TABLE `qa_ce_higher_bandwidth1` DISABLE KEYS */;
/*!40000 ALTER TABLE `qa_ce_higher_bandwidth1` ENABLE KEYS */;
UNLOCK TABLES;
