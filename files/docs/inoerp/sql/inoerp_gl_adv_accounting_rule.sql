...
--
-- Table structure for table `gl_adv_accounting_rule`
--

DROP TABLE IF EXISTS `gl_adv_accounting_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gl_adv_accounting_rule` (
  `gl_adv_accounting_rule_id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`gl_adv_accounting_rule_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gl_adv_accounting_rule`
--

LOCK TABLES `gl_adv_accounting_rule` WRITE;
/*!40000 ALTER TABLE `gl_adv_accounting_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `gl_adv_accounting_rule` ENABLE KEYS */;
UNLOCK TABLES;
