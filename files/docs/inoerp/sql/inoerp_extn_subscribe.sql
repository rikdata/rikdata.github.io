...
DROP TABLE IF EXISTS `extn_subscribe`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `extn_subscribe` (
  `extn_subscribe_id` int unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `extn_subscribe`
--

LOCK TABLES `extn_subscribe` WRITE;
/*!40000 ALTER TABLE `extn_subscribe` DISABLE KEYS */;
/*!40000 ALTER TABLE `extn_subscribe` ENABLE KEYS */;
UNLOCK TABLES;
