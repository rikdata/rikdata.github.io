...
DROP TABLE IF EXISTS `qa_ce_lower_bandwidth2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qa_ce_lower_bandwidth2` (
  `qa_ce_lower_bandwidth2_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `qa_ce_lower_bandwidth2`
--

LOCK TABLES `qa_ce_lower_bandwidth2` WRITE;
/*!40000 ALTER TABLE `qa_ce_lower_bandwidth2` DISABLE KEYS */;
/*!40000 ALTER TABLE `qa_ce_lower_bandwidth2` ENABLE KEYS */;
UNLOCK TABLES;
