...
DROP TABLE IF EXISTS `qa_cp_line`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qa_cp_line` (
  `qa_cp_line_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `qa_cp_line`
--

LOCK TABLES `qa_cp_line` WRITE;
/*!40000 ALTER TABLE `qa_cp_line` DISABLE KEYS */;
/*!40000 ALTER TABLE `qa_cp_line` ENABLE KEYS */;
UNLOCK TABLES;
