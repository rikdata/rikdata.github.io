...
CREATE TABLE `prj_milestone` (
  `prj_milestone_id` int unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `prj_milestone`
--

LOCK TABLES `prj_milestone` WRITE;
/*!40000 ALTER TABLE `prj_milestone` DISABLE KEYS */;
/*!40000 ALTER TABLE `prj_milestone` ENABLE KEYS */;
UNLOCK TABLES;
