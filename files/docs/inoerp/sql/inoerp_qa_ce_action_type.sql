...
DROP TABLE IF EXISTS `qa_ce_action_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qa_ce_action_type` (
  `qa_ce_action_type_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `qa_ce_action_type`
--

LOCK TABLES `qa_ce_action_type` WRITE;
/*!40000 ALTER TABLE `qa_ce_action_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `qa_ce_action_type` ENABLE KEYS */;
UNLOCK TABLES;
