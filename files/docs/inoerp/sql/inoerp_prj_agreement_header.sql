...
DROP TABLE IF EXISTS `prj_agreement_header`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prj_agreement_header` (
  `prj_agreement_header_id` int NOT NULL AUTO_INCREMENT,
  ...
  `admin_employee_id` int DEFAULT NULL,
...
--
-- Dumping data for table `prj_agreement_header`
--

LOCK TABLES `prj_agreement_header` WRITE;
/*!40000 ALTER TABLE `prj_agreement_header` DISABLE KEYS */;
INSERT INTO `prj_agreement_header` VALUES (1,5,NULL,NULL,2,4,NULL,NULL,NULL,NULL,NULL,8000.00000,'USD','USD','USER',NULL,1,1,NULL,'1','2021-10-04 12:31:59','1','2021-10-04 12:38:17');
/*!40000 ALTER TABLE `prj_agreement_header` ENABLE KEYS */;
UNLOCK TABLES;
