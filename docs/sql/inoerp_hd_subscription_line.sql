...
DROP TABLE IF EXISTS `hd_subscription_line`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hd_subscription_line` (
  `hd_subscription_line_id` int NOT NULL AUTO_INCREMENT,
  `hd_subscription_header_id` int NOT NULL,
  `line_number` int NOT NULL,
  `shipping_org_id` int DEFAULT NULL,
  ...
  UNIQUE KEY `hd_subscription_header_id` (`hd_subscription_header_id`,`inv_item_master_id`,`line_type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hd_subscription_line`
--

LOCK TABLES `hd_subscription_line` WRITE;
/*!40000 ALTER TABLE `hd_subscription_line` DISABLE KEYS */;
/*!40000 ALTER TABLE `hd_subscription_line` ENABLE KEYS */;
UNLOCK TABLES;
