...
--
-- Table structure for table `hd_repair_type_line`
--

DROP TABLE IF EXISTS `hd_repair_type_line`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hd_repair_type_line` (
...
--
-- Dumping data for table `hd_repair_type_line`
--

LOCK TABLES `hd_repair_type_line` WRITE;
/*!40000 ALTER TABLE `hd_repair_type_line` DISABLE KEYS */;
/*!40000 ALTER TABLE `hd_repair_type_line` ENABLE KEYS */;
UNLOCK TABLES;
