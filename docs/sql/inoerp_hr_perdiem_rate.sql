...
DROP TABLE IF EXISTS `hr_perdiem_rate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hr_perdiem_rate` (
  `hr_perdiem_rate_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `hr_perdiem_rate`
--

LOCK TABLES `hr_perdiem_rate` WRITE;
/*!40000 ALTER TABLE `hr_perdiem_rate` DISABLE KEYS */;
/*!40000 ALTER TABLE `hr_perdiem_rate` ENABLE KEYS */;
UNLOCK TABLES;
