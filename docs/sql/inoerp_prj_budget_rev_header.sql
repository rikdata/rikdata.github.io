...
DROP TABLE IF EXISTS `prj_budget_rev_header`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prj_budget_rev_header` (
  `prj_budget_rev_header_id` int unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `prj_budget_rev_header`
--

LOCK TABLES `prj_budget_rev_header` WRITE;
/*!40000 ALTER TABLE `prj_budget_rev_header` DISABLE KEYS */;
/*!40000 ALTER TABLE `prj_budget_rev_header` ENABLE KEYS */;
UNLOCK TABLES;
