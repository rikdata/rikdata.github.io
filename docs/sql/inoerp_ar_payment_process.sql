...
DROP TABLE IF EXISTS `ar_payment_process`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ar_payment_process` (
...
--
-- Dumping data for table `ar_payment_process`
--

LOCK TABLES `ar_payment_process` WRITE;
/*!40000 ALTER TABLE `ar_payment_process` DISABLE KEYS */;
/*!40000 ALTER TABLE `ar_payment_process` ENABLE KEYS */;
UNLOCK TABLES;
