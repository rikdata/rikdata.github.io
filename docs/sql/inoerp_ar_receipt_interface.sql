...
--
-- Table structure for table `ar_receipt_interface`
--

DROP TABLE IF EXISTS `ar_receipt_interface`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ar_receipt_interface` (
  `ar_receipt_interface_id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ar_receipt_interface_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ar_receipt_interface`
--

LOCK TABLES `ar_receipt_interface` WRITE;
/*!40000 ALTER TABLE `ar_receipt_interface` DISABLE KEYS */;
/*!40000 ALTER TABLE `ar_receipt_interface` ENABLE KEYS */;
UNLOCK TABLES;
