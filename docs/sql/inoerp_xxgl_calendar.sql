...
--
-- Table structure for table `xxgl_calendar`
--

DROP TABLE IF EXISTS `xxgl_calendar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `xxgl_calendar` (
...
--
-- Dumping data for table `xxgl_calendar`
--

LOCK TABLES `xxgl_calendar` WRITE;
/*!40000 ALTER TABLE `xxgl_calendar` DISABLE KEYS */;
/*!40000 ALTER TABLE `xxgl_calendar` ENABLE KEYS */;
UNLOCK TABLES;
