...
DROP TABLE IF EXISTS `hr_timesheet_line`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hr_timesheet_line` (
  `hr_timesheet_line_id` int unsigned NOT NULL AUTO_INCREMENT,
  `hr_timesheet_header_id` int NOT NULL,
...
--
-- Dumping data for table `hr_timesheet_line`
--

LOCK TABLES `hr_timesheet_line` WRITE;
/*!40000 ALTER TABLE `hr_timesheet_line` DISABLE KEYS */;
/*!40000 ALTER TABLE `hr_timesheet_line` ENABLE KEYS */;
UNLOCK TABLES;
