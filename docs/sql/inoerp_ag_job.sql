...
--
-- Table structure for table `ag_job`
--

DROP TABLE IF EXISTS `ag_job`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ag_job` (
  `ag_job_id` int unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ag_job`
--

LOCK TABLES `ag_job` WRITE;
/*!40000 ALTER TABLE `ag_job` DISABLE KEYS */;
/*!40000 ALTER TABLE `ag_job` ENABLE KEYS */;
UNLOCK TABLES;
