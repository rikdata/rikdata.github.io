...
--
-- Table structure for table `xx_locator`
--

DROP TABLE IF EXISTS `xx_locator`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `xx_locator` (
...
--
-- Dumping data for table `xx_locator`
--

LOCK TABLES `xx_locator` WRITE;
/*!40000 ALTER TABLE `xx_locator` DISABLE KEYS */;
/*!40000 ALTER TABLE `xx_locator` ENABLE KEYS */;
UNLOCK TABLES;
