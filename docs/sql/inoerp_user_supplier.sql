...
CREATE TABLE `user_supplier` (
  `user_supplier_id` int unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `user_supplier` WRITE;
/*!40000 ALTER TABLE `user_supplier` DISABLE KEYS */;
INSERT INTO `user_supplier` VALUES (1,93,2,3,'1','2021-10-04 12:34:15','1','2021-10-04 12:38:25');
