...
--
-- Table structure for table `pm_formula_ingredient`
--

DROP TABLE IF EXISTS `pm_formula_ingredient`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pm_formula_ingredient` (
  `pm_formula_ingredient_id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `buffer_cb` tinyint(1) DEFAULT NULL,
  ...
  PRIMARY KEY (`pm_formula_ingredient_id`),
  UNIQUE KEY `org_id` (`pm_formula_header_id`,`line_no`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pm_formula_ingredient`
--

LOCK TABLES `pm_formula_ingredient` WRITE;
/*!40000 ALTER TABLE `pm_formula_ingredient` DISABLE KEYS */;
/*!40000 ALTER TABLE `pm_formula_ingredient` ENABLE KEYS */;
UNLOCK TABLES;
