...
DROP TABLE IF EXISTS `qa_ce_enc_rating`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qa_ce_enc_rating` (
  `qa_ce_enc_rating_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `qa_ce_enc_rating`
--

LOCK TABLES `qa_ce_enc_rating` WRITE;
/*!40000 ALTER TABLE `qa_ce_enc_rating` DISABLE KEYS */;
/*!40000 ALTER TABLE `qa_ce_enc_rating` ENABLE KEYS */;
UNLOCK TABLES;
