...
DROP TABLE IF EXISTS `prj_invoice_line`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prj_invoice_line` (
  `prj_invoice_line_id` int NOT NULL AUTO_INCREMENT,
  `prj_invoice_header_id` int NOT NULL,
...
--
-- Dumping data for table `prj_invoice_line`
--

LOCK TABLES `prj_invoice_line` WRITE;
/*!40000 ALTER TABLE `prj_invoice_line` DISABLE KEYS */;
/*!40000 ALTER TABLE `prj_invoice_line` ENABLE KEYS */;
UNLOCK TABLES;
