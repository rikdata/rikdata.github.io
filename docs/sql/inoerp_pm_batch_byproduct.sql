...
--
-- Table structure for table `pm_batch_byproduct`
--

DROP TABLE IF EXISTS `pm_batch_byproduct`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pm_batch_byproduct` (
  `pm_batch_byproduct_id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`pm_batch_byproduct_id`),
  UNIQUE KEY `org_id` (`pm_batch_header_id`,`line_no`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pm_batch_byproduct`
--

LOCK TABLES `pm_batch_byproduct` WRITE;
/*!40000 ALTER TABLE `pm_batch_byproduct` DISABLE KEYS */;
/*!40000 ALTER TABLE `pm_batch_byproduct` ENABLE KEYS */;
UNLOCK TABLES;
