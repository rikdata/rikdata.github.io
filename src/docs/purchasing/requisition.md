...
Enter the organization/requisition details or any other criteria in the search form and click on the search button to view an existing requisition.  
...
You can also click on the expand icon against any item on the search result screen to view the requisition header details such as requisition number, quantities, start date, status, etc.
...
<img src="/images/modules/po/requisition/requisition_06.PNG" width="800"/>
...
|**250**|*porequisitionHeaderId*|Po requisition Header Id |InputType.number|REFERENCE|
...
|**340**|*refPorequisitionHeaderId*|Ref Po requisition Header Id |InputType.number|REFERENCE|
...
|**550**|*requisitionNumber*|requisition Number |InputType.textField|DATA|
...
|**180**|*porequisitionLineId*|Po requisition Line Id |InputType.number|REFERENCE|
|**190**|*srcEntityName*|Src Entity Name |InputType.textField|DEFAULT|
|**200**|*srcEntityId*|Src Entity Id |InputType.textField|REFERENCE|
|**210**|*porequisitionHeaderId*|Po requisition Header Id |InputType.number|REFERENCE|
...
You can add multiple details to each requisition line. Each requisition detail contains quantity, need by date, promise date, etc.
...
|**240**|*porequisitionDetailId*|Po requisition Detail Id |InputType.number|REFERENCE|
|**250**|*srcEntityName*|Src Entity Name |InputType.textField|DEFAULT|
|**260**|*srcEntityId*|Src Entity Id |InputType.textField|REFERENCE|
|**270**|*porequisitionLineId*|Po requisition Line Id |InputType.number|REFERENCE|
...
<img src="/images/modules/po/requisition/requisition_09.PNG" width="800"/>
